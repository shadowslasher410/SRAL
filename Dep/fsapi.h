...
typedef struct IJawsApiVtbl {
	...
	HRESULT(STDMETHODCALLTYPE* QueryInterface)(IJawsApi* This,
		/* [in] */ REFIID riid,
		/* [annotation][iid_is][out] */
		_COM_Outptr_ void** ppvObject);

	ULONG(STDMETHODCALLTYPE* AddRef)(IJawsApi* This);

	ULONG(STDMETHODCALLTYPE* Release)(IJawsApi* This);

	HRESULT(STDMETHODCALLTYPE* GetTypeInfoCount)(IJawsApi* This,
		/* [out] */ UINT* pctinfo);

	HRESULT(STDMETHODCALLTYPE* GetTypeInfo)(IJawsApi* This,
		/* [in] */ UINT iTInfo,
		/* [in] */ LCID lcid,
		/* [out] */ ITypeInfo** ppTInfo);

	HRESULT(STDMETHODCALLTYPE* GetIDsOfNames)(IJawsApi* This,
		/* [in] */ REFIID riid,
	...
	/* [local] */ HRESULT(STDMETHODCALLTYPE* Invoke)(IJawsApi* This,
		/* [annotation][in] */
	...
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE* RunScript)(IJawsApi* This,
		/* [in] */ BSTR ScriptName,
		/* [retval][out] */ VARIANT_BOOL* vbSuccess);

	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE* SayString)(IJawsApi* This,
		/* [in] */ BSTR StringToSpeak,
		/* [defaultvalue][optional][in] */ VARIANT_BOOL bFlush,
		/* [retval][out] */ VARIANT_BOOL* vbSuccess);

	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE* StopSpeech)(IJawsApi* This);

	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE* Enable)(IJawsApi* This,
		/* [in] */ VARIANT_BOOL vbNoDDIHooks,
		/* [retval][out] */ VARIANT_BOOL* vbSuccess);

	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE* Disable)(IJawsApi* This,
		/* [retval][out] */ VARIANT_BOOL* vbSuccess);

	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE* RunFunction)(IJawsApi* This,
		/* [in] */ BSTR FunctionName,
		/* [retval][out] */ VARIANT_BOOL* vbSuccess);
...
#define IJawsApi_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define IJawsApi_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IJawsApi_Release(This) ((This)->lpVtbl->Release(This))

#define IJawsApi_GetTypeInfoCount(This, pctinfo) ((This)->lpVtbl->GetTypeInfoCount(This, pctinfo))

#define IJawsApi_GetTypeInfo(This, iTInfo, lcid, ppTInfo) ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))
...
#define IJawsApi_RunScript(This, ScriptName, vbSuccess) ((This)->lpVtbl->RunScript(This, ScriptName, vbSuccess))

#define IJawsApi_SayString(This, StringToSpeak, bFlush, vbSuccess)                                                     \
	((This)->lpVtbl->SayString(This, StringToSpeak, bFlush, vbSuccess))

#define IJawsApi_StopSpeech(This) ((This)->lpVtbl->StopSpeech(This))

#define IJawsApi_Enable(This, vbNoDDIHooks, vbSuccess) ((This)->lpVtbl->Enable(This, vbNoDDIHooks, vbSuccess))

#define IJawsApi_Disable(This, vbSuccess) ((This)->lpVtbl->Disable(This, vbSuccess))

#define IJawsApi_RunFunction(This, FunctionName, vbSuccess) ((This)->lpVtbl->RunFunction(This, FunctionName, vbSuccess))
...
class DECLSPEC_UUID("CCE5B1E5-B2ED-45D5-B09F-8EC54B75ABF4") JawsApi;
#endif
