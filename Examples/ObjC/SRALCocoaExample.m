...
static void sleep_ms(const int milliseconds) {
    if (milliseconds > 0) {
        [NSThread sleepForTimeInterval:(double)milliseconds / 1000.0];
    }
}
...
int main(__unused int argc, __unused const char * argv[]) {
    @autoreleasepool {
        ...
        printf("SRAL Cross-Platform Verification Tester (Objective-C)\n");
        printf("----------------------------------------------------\n");
        ...
        printf("Attempting to initialize SRAL, excluding engines: 0x%X (%s)\n",
            engines_to_exclude,
            excludeEngineName ? excludeEngineName : "None");
        ...
        printf("Current Default Engine: %s (0x%X)\n",
            currentEngineName ? currentEngineName : "None/Unknown",
            current_engine_id);
        ...
        const char* const defaultEngineName = SRAL_GetEngineName(current_engine_id);
        printf("Features for Current Default Engine (%s):\n", defaultEngineName ? defaultEngineName : "None");
