...
public:
	...
	bool IsSpeaking() { return synth.isSpeaking; }
	bool GetActive() { return synth != nil; }
	void SetVolume(int value) { this->volume = value; }
	int GetVolume() { return this->volume; }
	void SetRate(int value) { this->rate = value; }
...
bool AvSpeech::Uninitialize() {
	ReleaseAllStrings();
	if (obj == nullptr)
		return false; // Check for nullptr
	delete obj;
