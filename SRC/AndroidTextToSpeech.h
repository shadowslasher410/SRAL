...
public:
	...
	int GetNumber() override { return SRAL_ENGINE_ANDROID_TEXT_TO_SPEECH; }
...
private:
	jclass speechClass;
	jmethodID constructor, midIsActive, midIsSpeaking, midSpeak, midSilence, midGetVoice, midSetRate, midSetPitch,
		midSetVolume, midGetVoices, midSetVoice, midGetMaxSpeechInputLength, midGetPitch, midGetRate, midGetVolume;
	JNIEnv* env;
	jobject speechObj;
};
} // namespace Sral
