...
public:
	...
	int GetNumber() override { return SRAL_ENGINE_SAPI; }
	...
	int GetFeatures() override {
		return SRAL_SUPPORTS_SPEECH | SRAL_SUPPORTS_SPEECH_RATE | SRAL_SUPPORTS_SPEECH_VOLUME |
			SRAL_SUPPORTS_SELECT_VOICE | SRAL_SUPPORTS_PAUSE_SPEECH | SRAL_SUPPORTS_SPEAK_TO_MEMORY;
	}
	int GetKeyFlags() override { return HANDLE_INTERRUPT | HANDLE_PAUSE_RESUME; }
